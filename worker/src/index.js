...
PROSPECTO_TELEFONO: [número de teléfono/WhatsApp del prospecto si aparece en la transcripción, o "No detectado"]`,
    ...
    promptWithDescal += `\n\n---\nHIGHLIGHTS DE LA TRANSCRIPCIÓN\n\nIdentifica fragmentos de la transcripción que correspondan a:\n- **momento_critico**: momentos donde se define el resultado de la llamada (objeción no manejada, pregunta clave, admisión del prospecto, pivote emocional, dato revelador).\n- **patron_error**: patrones repetitivos del vendedor que dañan la venta (muletillas, no validar precio contra mercado, aceptar expectativas sin cuestionar, no hacer preguntas de descubrimiento, cerrar sin confirmar siguiente paso).\n\nOBJETIVO: Identifica AL MENOS 4 y hasta 10 highlights combinados por llamada. Una llamada de >5 minutos típicamente tiene 5-8 highlights relevantes. Si identificas menos de 4 estás siendo demasiado conservador — revisa de nuevo.\n\nREGLA CRÍTICA — COPIA LITERAL:\nEl campo "snippet" DEBE ser un fragmento copiado CARÁCTER POR CARÁCTER de la transcripción original, incluyendo:\n- Errores de transcripción (ej: si dice "libres" NO lo cambies a "libras")\n- Puntuación exacta (comas, puntos, espacios)\n- Mayúsculas/minúsculas exactas\n- Acentos exactos\n\nSi modificas un solo carácter el sistema descartará el highlight. NO parafrasees, NO corrijas, NO normalices. Copia literal.\n\nEjemplo correcto (snippet EXISTE tal cual en la transcripción):\n{"type":"momento_critico","snippet":"Yo creo que algunos 300. 300. 000 libres.","description":"Prospecto revela expectativa de precio sin validar contra mercado"}\n\nEjemplo INCORRECTO (snippet parafraseado — sería descartado):\n{"type":"momento_critico","snippet":"El prospecto dice que espera 300 mil libres","description":"..."}\n\nFormato de salida al final de tu respuesta:\nHIGHLIGHTS: [{"type":"momento_critico","snippet":"<copia literal>","description":"<por qué es crítico, 1 línea>"},{"type":"patron_error","snippet":"<copia literal>","description":"<qué patrón>"}]\n\nReglas finales:\n- Mínimo 4 highlights combinados, máximo 10.\n- Máximo 6 por tipo.\n- Cada snippet entre 15 y 200 caracteres.\n- Si un snippet es muy largo, córtalo en el carácter que más aporta, sin modificar el texto interior.`;
