 ...
 *
 * Port verbatim de supabase/functions/_shared/phone.ts (SoT canónica del backend).
 * Existe duplicado intencional para evitar imports cross-stack entre Next.js y
 * Deno Edge Functions. Mantener sincronizadas si el algoritmo cambia upstream.
 */
