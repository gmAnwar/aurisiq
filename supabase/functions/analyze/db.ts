...
// above; Worker (worker/src/lib/phone.js) consumes its own port. Keep this
// in sync if the algorithm changes upstream.
/**
...
export async function writeAnalysisResults(
  ...
  // F48b: ya derivado por computeScoreDesempeno en el caller (puro, testeable).
